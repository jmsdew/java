...
public class Application01 {
    public static void main(String[] args) throws Exception{
        ...
        * 코드를 컴파일 하려고 할 때 컴파일 에러를 발생시키거나,(엄밀히 말하면 문법상의 오류(Syntax Error)이다.)
        * 혹은 자바 문법에 맞게 작성하여 컴파일에 문제가 없더라도, 실행되면서 예상하지 못하게
        * 오류가 발생할 수 있다.
        * 컴퓨터 프로그램이 동작하는 도중에 예상하지 못한 사태가 발생되며
        * 실행중인 프로그램이 영향을 받는 것을 오류(Error) 에외(Excetion) 두 가지로 구분할 수 있다.
        *
        *
        * 오류(Error)
        ...
        * */
        ...
        et.checkEnoghMoney(1000,100);

        et.checkEnoghMoney(5000,10000);
