package main.java.com.ogiraffer.section03.math;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("-1.25의 절대값 : " + (Math.abs(-1.25)));   // 자바 기본 제공 api - import 필요없음
        System.out.println("10과 20중 더 작은 것은? " + (Math.min(10,20)));
        System.out.println("10과 20중 더 큰 것은? " + (Math.max(10,20)));

        System.out.println("원주율 : " + (Math.PI));
        System.out.println("난수 발생 : " + (int)(Math.random()*10)); //랜덤은 double 사용 0.~~~

        Random randon = new Random();
        int randomNumber = randon.nextInt(10);
