...
public class Application1 {
    public static void main(String[] args){
        ...
        * */
        ...
        main.java.com.ogiraffer.section01.method.Calculator cal = new  main.java.com.ogiraffer.section01.method.Calculator();
        //위치 호출 - 같은 패키지는 명시하지 않음
        
        System.out.println(cal.minNumberOf(1,2));
        System.out.println(main.java.com.ogiraffer.section01.method.Calculator.maxNumberOf(1,2));
    }
}
