...
import main.java.com.ohgiraffers.section01.list.comporator.AscendingPrice;
...
public class Application02 {
    public static void main(String[] args){
        ...
        /*
        * Comparator 인터페이스를 상속받아 정렬의 기준을 정해준 뒤 list의 default 메소드인
        * sort()의 메소드의 인자로 정렬 기준이 되는 인스턴스를 넣어주게 되면 내부적으로 우리가 오버라이딩 한 메소드가
        * 동작하게 되며 그것을 정렬 기준으로 삼는다.
        * */
