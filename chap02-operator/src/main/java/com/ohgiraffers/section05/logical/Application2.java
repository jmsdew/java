...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         * && : 11순위
         * || : 12순위
         * 논리 and 연산자 우선순위가 or 연산자 우선순위보다 높다.
         *
         * */
        ...
        int num2 = 166;
        System.out.println("1부터 100 사이 인지 확인 : " + ((num2 >= 1) && (num2 <= 100)));
        ...
        char ch5 = 'f';
        boolean ch1 = ( (ch5 >= 'A') && (ch5 <= 'Z'));
        boolean ch2 = ((ch5 >= 'a') && (ch5 <= 'z'));
        System.out.println("영문자인지 확인 : " + ( ( (ch5 >= 'A') && (ch5 <= 'Z') ) || ( (ch5 >= 'a') && (ch5 <= 'z') ) ) );

        System.out.println("영문자인지 확인 : " + (ch1 || ch2));
