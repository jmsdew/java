...
public class Application01 {
    public static void main(String[] args){
        ...
        * 2. 모든 회원 정보를 메소드 인자로 호출 시 값을 전달해야 하면 너무 많은 값들을 인자로 전달해야 해서 한 눈에 안 들어온다.
        * 3. 리턴은 1개 값만 가능하기 때문에 회원정보를 묶어서 리턴 값으로 사용할 수 없다.(자료형이 서로 다르기 때문이다.)
        * */
    ...
    public static Member modyfyMember(Member member){
