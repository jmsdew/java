...
public class Application03 {
    public static void main(String[] args){
        ...
        /*
        * 깊은 복사는 heap에 생선된 배열이 가지고 있는 값을
        ...
        * */
        ...
        System.arraycopy(originArr, 0, copyArr3, 3, originArr.length); // origin의 0번부터를 copy3의 3번부터 복사
        print(copyArr3);

        // Arry의 copyOf 를 이용한 복사
        System.out.println("copyOf : ");
        int[] copyArr4 = Arrays.copyOf(originArr, originArr.length);  // 넘는 숫자 입력시 0이 뒤에 붙어서 출력
        print(copyArr4);
