...
public class Application02 {
    public static void main(String[] args){
        ...
        * 발생한 주소를 레퍼런스 주소(참조 변수)에 저장하여 이것을 사용하기 때문에 참조자료형(reference type)이라고 한다.
        * */
        iarray = new int[5];
        array = new int[10];
        int[] test = iarray;
        ...
        /*
        * heap 메모리는 이름을 접근하는 것이 아닌 주소로 접근하는 영역으로
        ...
        * 동일객체인지 비교할 때 사용할 목적으로 쓰이며, 동등객체를 동일객체 취급하기 위한 용도로 overring 해서 사용한다.
        * */

        System.out.println("iarray의 hashcode = " + iarray.hashCode());
        System.out.println("array의 hashCode = " + array.hashCode());
        System.out.println("test array의 hashCode = " +test.hashCode());
