...
public class Application03 {
    public static void main(String[] args){
        ...
        *   1-2 예약어는 사용이 불가능하다(예약어란 프로그램에서 미리 사용하겠다고 compiler와 약속한 키워드)
      ...
      //  int true = 10;
        ...
        // 1-3 변수명은 대소문자를 구분한다. (개발자는 쓰지 않음)
        int Age = 20;
        int True = 30;
        ...
        // 2-1 에러를 발생시키지 않지만 개발자들 끼리의 암묵적인 규칙
        int qfqwaskfaskfnpknpancpasnkasnjansjvdab;
        ...
        String user_name; // 스네이크 케이스 - 단어와 단어 사이를 언더스코어로 하는 것.-_-_-_
        String userName; // 카멜 케이스 - 단어와 단어 사이를 대문자로

        // 2-4 한글로 변수명을 짓는 것은 가능하지만 권장하지 않는다.
        int 나이;

        // 2-5 변수 안에 저장된 값이 어떤 의미를 가지는지 명화가게 표현하도록 한다.
        String s;
        String name;
        ...
        boolean isDead = false; //부정형보다 긍정형을 권장한다.
    }
}
